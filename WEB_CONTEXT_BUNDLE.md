...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-e26acef0be02310f"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-e26acef0be02310f",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-e26acef0be02310f",
        "url": "https://en.wikipedia.org/wiki/Palindromic_prime"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Are there infinitely many palindromic primes to every base?",
      "version": 1
    },
    "title": "Are there infinitely many palindromic primes to every base?",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "7001588e6635db43a46e340a1142010c151a69bf8b72b83e3943d1330ca4c09b"
}
```
